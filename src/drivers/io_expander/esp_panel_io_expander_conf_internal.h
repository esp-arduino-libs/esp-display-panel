...
#if ESP_PANEL_DRIVERS_EXPANDER_ENABLE_CH422G || ESP_PANEL_DRIVERS_EXPANDER_ENABLE_HT8574 || \
    ESP_PANEL_DRIVERS_EXPANDER_ENABLE_TCA95XX_8BIT || ESP_PANEL_DRIVERS_EXPANDER_ENABLE_TCA95XX_16BIT
    #define ESP_PANEL_DRIVERS_EXPANDER_ENABLE_FACTORY   (1)
#else
    #define ESP_PANEL_DRIVERS_EXPANDER_ENABLE_FACTORY   (0)
#endif
