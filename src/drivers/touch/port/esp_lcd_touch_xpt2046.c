...
#define CONFIG_XPT2046_Z_THRESHOLD              (ESP_PANEL_CONF_TOUCH_XPT2046_Z_THRESHOLD)
#if ESP_PANEL_CONF_TOUCH_XPT2046_INTERRUPT_MODE
#define CONFIG_XPT2046_INTERRUPT_MODE           (ESP_PANEL_CONF_TOUCH_XPT2046_INTERRUPT_MODE)
#endif
#if ESP_PANEL_CONF_TOUCH_XPT2046_VREF_ON_MODE
#define CONFIG_XPT2046_VREF_ON_MODE             (ESP_PANEL_CONF_TOUCH_XPT2046_VREF_ON_MODE)
#endif
#define CONFIG_XPT2046_CONVERT_ADC_TO_COORDS    (ESP_PANEL_CONF_TOUCH_XPT2046_CONVERT_ADC_TO_COORDS)
