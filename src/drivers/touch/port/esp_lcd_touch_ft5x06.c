...
#if ESP_PANEL_DRIVERS_TOUCH_ENABLE_FT5x06
...
{
    ESP_LOGI(TAG, "version: %d.%d.%d", ESP_LCD_TOUCH_FT5x06_VER_MAJOR, ESP_LCD_TOUCH_FT5x06_VER_MINOR,
...
#endif // ESP_PANEL_DRIVERS_TOUCH_ENABLE_FT5x06
