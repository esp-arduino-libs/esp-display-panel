...
/**
 * @brief GT1151 touch device object class
 *
...
public:
     ...
     */
    TouchGT1151(std::shared_ptr<Bus> bus, const Config &config): Touch(bus, config, ATTRIBUTES_DEFAULT) {}
 ...
 *             Please use `esp_panel::drivers::TouchGT1151` instead.
 *
 */
typedef esp_panel::drivers::TouchGT1151 ESP_PanelTouch_GT1151 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::TouchGT1151` instead.")));
