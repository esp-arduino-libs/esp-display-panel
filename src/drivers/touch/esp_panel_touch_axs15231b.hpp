...
/**
 * @brief AXS15231B touch controller
 *
 * This class provides implementation for AXS15231B touch controller, inheriting from
 * the base Touch class to provide common touch functionality
 */
class TouchAXS15231B : public Touch {
public:
    /**
     * @brief Default basic attributes for AXS15231B
     */
     ...
     */
    TouchAXS15231B(Bus *bus, const Config &config): Touch(BASIC_ATTRIBUTES_DEFAULT, bus, config) {}
 ...
 * @deprecated Use `esp_panel::drivers::TouchAXS15231B` instead
 */
using ESP_PanelTouch_AXS15231B [[deprecated("Please use `esp_panel::drivers::TouchAXS15231B` instead")]] =
    esp_panel::drivers::TouchAXS15231B;
