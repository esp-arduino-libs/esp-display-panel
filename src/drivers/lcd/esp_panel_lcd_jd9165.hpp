...
/**
 * @brief JD9165 LCD device object class
 *
...
public:
    ...
    /**
     * @brief Construct a JD9165 LCD device
     *
    ...
    /**
     * @brief Construct a new JD9165 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_JD9165(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_JD9165` instead.
 *
 */
typedef esp_panel::drivers::LCD_JD9165 ESP_PanelLcd_JD9165 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_JD9165` instead.")));
