...
/**
 * @brief The GC9503 LCD device class
 *
...
// *INDENT-OFF*
     ...
     */
    LCD_GC9503(Bus *panel_bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_GC9503(std::shared_ptr<Bus> panel_bus, const Config &config):
...
/**
 * @deprecated Deprecated. Please use `esp_panel::drivers::LCD_GC9503
 *             instead.
 */
typedef esp_panel::drivers::LCD_GC9503 LCD_GC9503 __attribute__((deprecated("Deprecated and will be removed in the \
next major version. Please use `esp_panel::drivers::LCD_GC9503` instead.")));
