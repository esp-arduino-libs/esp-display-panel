...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_GC9503` class
 * @deprecated Use `esp_panel::drivers::LCD_GC9503` instead. Will be removed in next major version
 */
