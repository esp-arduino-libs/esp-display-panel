...
public:
    ...
    /**
     * @brief Construct a ST7789 LCD device
     *
    ...
    /**
     * @brief Construct a new ST7789 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_ST7789(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_ST7789` instead.
 *
 */
typedef esp_panel::drivers::LCD_ST7789 ESP_PanelLcd_ST7789 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_ST7789` instead.")));
