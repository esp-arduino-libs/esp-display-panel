...
/**
 * @brief LCD driver class for ST7703 display controller
 *
 */
class LCD_ST7703: public LCD {
public:
    /**
     * @brief Default basic attributes for ST7703 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_ST7703(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_ST7703` class
 * @deprecated Use `esp_panel::drivers::LCD_ST7703` instead. Will be removed in next major version
 */
using ESP_PanelLcd_ST7703 [[deprecated("Use `esp_panel::drivers::LCD_ST7703` instead")]] =
    esp_panel::drivers::LCD_ST7703;
