...
public:
    ...
    /**
     * @brief Construct a SPD2010 LCD device
     *
    ...
    /**
     * @brief Construct a new SPD2010 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_SPD2010(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_SPD2010` instead.
 *
 */
typedef esp_panel::drivers::LCD_SPD2010 ESP_PanelLcd_SPD2010 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_SPD2010` instead.")));
