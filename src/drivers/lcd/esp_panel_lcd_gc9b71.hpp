...
public:
    ...
    /**
     * @brief Construct a GC9B71 LCD device
     *
    ...
    /**
     * @brief Construct a new GC9B71 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_GC9B71(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_GC9B71` instead.
 *
 */
typedef esp_panel::drivers::LCD_GC9B71 ESP_PanelLcd_GC9B71 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_GC9B71` instead.")));
