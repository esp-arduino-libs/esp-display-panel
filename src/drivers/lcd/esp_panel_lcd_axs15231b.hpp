...
/**
 * @brief LCD driver class for AXS15231B display controller
 *
 */
class LCD_AXS15231B: public LCD {
public:
    /**
     * @brief Default basic attributes for AXS15231B LCD controller
     */
...
// *INDENT-ON*
     ...
     * @param[in] color_bits Color depth in bits per pixel (16/18)
     ...
     */
    LCD_AXS15231B(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_AXS15231B` class
 * @deprecated Use `esp_panel::drivers::LCD_AXS15231B` instead. Will be removed in next major version
 */
using ESP_PanelLcd_AXS15231B [[deprecated("Use `esp_panel::drivers::LCD_AXS15231B` instead")]] =
    esp_panel::drivers::LCD_AXS15231B;
