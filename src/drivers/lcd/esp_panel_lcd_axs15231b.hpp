...
/**
 * @brief The AXS15231B LCD device class
 *
...
// *INDENT-OFF*
     ...
     */
    LCD_AXS15231B(Bus *panel_bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_AXS15231B(std::shared_ptr<Bus> panel_bus, const Config &config):
...
/**
 * @deprecated Deprecated. Please use `esp_panel::drivers::LCD_AXS15231B`
 *             instead.
 *
 * @TODO Remove in the next major version
 */
typedef esp_panel::drivers::LCD_AXS15231B LCD_AXS15231B __attribute__((deprecated("Deprecated and will be removed in \
the next major version. Please use `esp_panel::drivers::LCD_AXS15231B` instead.")));
