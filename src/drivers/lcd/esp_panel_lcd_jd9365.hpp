...
/**
 * @brief LCD driver class for JD9365 display controller
 *
 */
class LCD_JD9365: public LCD {
public:
    /**
     * @brief Default basic attributes for JD9365 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_JD9365(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_JD9365` class
 * @deprecated Use `esp_panel::drivers::LCD_JD9365` instead. Will be removed in next major version
 */
using ESP_PanelLcd_JD9365 [[deprecated("Use `esp_panel::drivers::LCD_JD9365` instead")]] =
    esp_panel::drivers::LCD_JD9365;
