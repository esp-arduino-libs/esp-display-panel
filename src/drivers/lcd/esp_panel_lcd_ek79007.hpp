...
public:
    constexpr static Attributes ATTRIBUTES_DEFAULT = {
        .disable_swap_xy = 1,
        .disable_gap = 1,
        .disable_display_on_off = 1,
        .name = "EK79007",
    };

    /**
     * @brief Construct a EK79007 LCD device
     *
    ...
    /**
     * @brief Construct a new EK79007 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_EK79007(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_EK79007` instead.
 *
 */
typedef esp_panel::drivers::LCD_EK79007 ESP_PanelLcd_EK79007 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_EK79007` instead.")));
