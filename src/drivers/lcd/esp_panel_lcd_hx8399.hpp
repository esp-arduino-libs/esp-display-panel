...
/**
 * @brief LCD driver class for HX8399 display controller
 *
 */
class LCD_HX8399: public LCD {
public:
    /**
     * @brief Default basic attributes for HX8399 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_HX8399(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_HX8399` class
 * @deprecated Use `esp_panel::drivers::LCD_HX8399` instead. Will be removed in next major version
 */
using ESP_PanelLcd_HX8399 [[deprecated("Use `esp_panel::drivers::LCD_HX8399` instead")]] =
    esp_panel::drivers::LCD_HX8399;
