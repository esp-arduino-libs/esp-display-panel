...
/**
 * @brief The HX8399 LCD device class
 *
...
// *INDENT-OFF*
     ...
     */
    LCD_HX8399(Bus *panel_bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_HX8399(std::shared_ptr<Bus> panel_bus, const Config &config):
...
/**
 * @deprecated Deprecated. Please use `esp_panel::drivers::LCD_HX8399
 *             instead.
 */
typedef esp_panel::drivers::LCD_HX8399 LCD_HX8399 __attribute__((deprecated("Deprecated and will be removed in the \
next major version. Please use `esp_panel::drivers::LCD_HX8399` instead.")));
