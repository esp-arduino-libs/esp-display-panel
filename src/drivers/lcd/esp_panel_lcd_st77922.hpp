...
/**
 * @brief LCD driver class for ST77922 display controller
 *
 */
class LCD_ST77922: public LCD {
public:
    /**
     * @brief Default basic attributes for ST77922 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_ST77922(Bus *bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_ST77922(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_ST77922` class
 * @deprecated Use `esp_panel::drivers::LCD_ST77922` instead. Will be removed in next major version
 */
using ESP_PanelLcd_ST77922 [[deprecated("Use `esp_panel::drivers::LCD_ST77922` instead")]] =
    esp_panel::drivers::LCD_ST77922;
