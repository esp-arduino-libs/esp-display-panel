...
public:
    ...
    /**
     * @brief Construct a ST77922 LCD device
     *
    ...
    /**
     * @brief Construct a new ST77922 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_ST77922(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_ST77922` instead.
 *
 */
typedef esp_panel::drivers::LCD_ST77922 ESP_PanelLcd_ST77922 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_ST77922` instead.")));
