...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_ILI9341` class
 * @deprecated Use `esp_panel::drivers::LCD_ILI9341` instead. Will be removed in next major version
 */
