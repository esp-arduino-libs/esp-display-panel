...
/**
 * @brief LCD driver class for ST77916 display controller
 *
 */
class LCD_ST77916: public LCD {
public:
    /**
     * @brief Default basic attributes for ST77916 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_ST77916(Bus *bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_ST77916(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_ST77916` class
 * @deprecated Use `esp_panel::drivers::LCD_ST77916` instead. Will be removed in next major version
 */
using ESP_PanelLcd_ST77916 [[deprecated("Use `esp_panel::drivers::LCD_ST77916` instead")]] =
    esp_panel::drivers::LCD_ST77916;
