...
public:
    ...
    /**
     * @brief Construct a ST77916 LCD device
     *
    ...
    /**
     * @brief Construct a new ST77916 LCD device
     *
     * @param bus    Pointer of panel bus
     * @param config LCD configuration
     */
    LCD_ST77916(std::shared_ptr<Bus> bus, const Config &config):
 ...
 *             Please use `esp_panel::drivers::LCD_ST77916` instead.
 *
 */
typedef esp_panel::drivers::LCD_ST77916 ESP_PanelLcd_ST77916 __attribute__((deprecated("Deprecated and will be removed in the next major version. Please use `esp_panel::drivers::LCD_ST77916` instead.")));
