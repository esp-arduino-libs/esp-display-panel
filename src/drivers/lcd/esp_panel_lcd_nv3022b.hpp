...
/**
 * @brief The NV3022B LCD device class
 *
...
// *INDENT-OFF*
     ...
     */
    LCD_NV3022B(Bus *panel_bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_NV3022B(std::shared_ptr<Bus> panel_bus, const Config &config):
...
/**
 * @deprecated Deprecated. Please use `esp_panel::drivers::LCD_NV3022B
 *             instead.
 */
typedef esp_panel::drivers::LCD_NV3022B LCD_NV3022B __attribute__((deprecated("Deprecated and will be removed in the \
next major version. Please use `esp_panel::drivers::LCD_NV3022B` instead.")));
