...
/**
 * @brief LCD driver class for NV3022B display controller
 *
 */
class LCD_NV3022B: public LCD {
public:
    /**
     * @brief Default basic attributes for NV3022B LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_NV3022B(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_NV3022B` class
 * @deprecated Use `esp_panel::drivers::LCD_NV3022B` instead. Will be removed in next major version
 */
using ESP_PanelLcd_NV3022B [[deprecated("Use `esp_panel::drivers::LCD_NV3022B` instead")]] = esp_panel::drivers::LCD_NV3022B;
