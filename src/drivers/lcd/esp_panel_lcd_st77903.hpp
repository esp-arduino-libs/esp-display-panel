...
/**
 * @brief LCD driver class for ST77903 display controller
 *
 */
class LCD_ST77903: public LCD {
public:
    /**
     * @brief Default basic attributes for ST77903 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_ST77903(Bus *bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_ST77903(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_ST77903` class
 * @deprecated Use `esp_panel::drivers::LCD_ST77903` instead. Will be removed in next major version
 */
using ESP_PanelLcd_ST77903 [[deprecated("Use `esp_panel::drivers::LCD_ST77903` instead")]] =
    esp_panel::drivers::LCD_ST77903;
