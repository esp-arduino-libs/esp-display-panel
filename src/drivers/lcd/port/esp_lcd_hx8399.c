...
static const esp_panel_lcd_vendor_init_cmd_t vendor_specific_init_code_default[] = {
...
static esp_err_t panel_hx8399_init(esp_lcd_panel_t *panel)
{
    ...
    if (hx8399->init_cmds) {
        ...
        init_cmds_size = sizeof(vendor_specific_init_code_default) / sizeof(esp_panel_lcd_vendor_init_cmd_t);
    }
