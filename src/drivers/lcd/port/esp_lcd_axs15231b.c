...
#if ESP_PANEL_CONF_LCD_COMPILE_DISABLED || ESP_PANEL_CONF_LCD_ENABLE_AXS15231B
#include <stdlib.h>
#include <sys/cdefs.h>
...
esp_err_t esp_lcd_new_panel_axs15231b(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    if (panel_dev_config->vendor_config) {
        axs15231b->init_cmds = ((esp_panel_lcd_vendor_config_t *)panel_dev_config->vendor_config)->init_cmds;
        axs15231b->init_cmds_size = ((esp_panel_lcd_vendor_config_t *)panel_dev_config->vendor_config)->init_cmds_size;
        axs15231b->flags.use_qspi_interface = ((esp_panel_lcd_vendor_config_t *)panel_dev_config->vendor_config)->flags.use_qspi_interface;
    }
...
#endif // ESP_PANEL_CONF_LCD_COMPILE_DISABLED || ESP_PANEL_CONF_LCD_ENABLE_AXS15231B
