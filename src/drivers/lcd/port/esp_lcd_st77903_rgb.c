...
#if ESP_PANEL_CONF_LCD_COMPILE_DISABLED || ESP_PANEL_CONF_LCD_ENABLE_ST7796
...
{
    ESP_LOGI(TAG, "version: %d.%d.%d", ESP_LCD_ST77903_RGB_VER_MAJOR, ESP_LCD_ST77903_RGB_VER_MINOR,
             ESP_LCD_ST77903_RGB_VER_PATCH);
...
const static esp_panel_lcd_vendor_init_cmd_t vendor_specific_init_default[] = {
...
#endif // ESP_PANEL_CONF_LCD_COMPILE_DISABLED || ESP_PANEL_CONF_LCD_ENABLE_ST7796
