...
/**
 * @brief LCD driver class for SH8601 display controller
 *
 */
class LCD_SH8601: public LCD {
public:
    /**
     * @brief Default basic attributes for SH8601 LCD controller
     */
...
// *INDENT-ON*
     ...
     */
    LCD_SH8601(Bus *bus, const Config &config):
...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_SH8601` class
 * @deprecated Use `esp_panel::drivers::LCD_SH8601` instead. Will be removed in next major version
 */
using ESP_PanelLcd_SH8601 [[deprecated("Use `esp_panel::drivers::LCD_SH8601` instead")]] =
    esp_panel::drivers::LCD_SH8601;
