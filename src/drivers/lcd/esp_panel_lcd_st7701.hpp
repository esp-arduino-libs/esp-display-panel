...
/**
 * @brief The ST7701 LCD device class
 *
...
// *INDENT-OFF*
     ...
     */
    LCD_ST7701(Bus *panel_bus, uint8_t color_bits, int rst_io = -1):
     ...
     */
    LCD_ST7701(std::shared_ptr<Bus> panel_bus, const Config &config):
...
/**
 * @deprecated Deprecated. Please use `esp_panel::drivers::LCD_ST7701
 *             instead.
 */
typedef esp_panel::drivers::LCD_ST7701 LCD_ST7701 __attribute__((deprecated("Deprecated and will be removed in the \
next major version. Please use `esp_panel::drivers::LCD_ST7701` instead.")));
