...
/**
 * @brief Backward compatibility type alias for `ESP_PanelLcd_ST7796` class
 * @deprecated Use `esp_panel::drivers::LCD_ST7796` instead. Will be removed in next major version
 */
