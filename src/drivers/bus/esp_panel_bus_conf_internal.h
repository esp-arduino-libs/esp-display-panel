...
#if ESP_PANEL_DRIVERS_BUS_ENABLE_SPI || ESP_PANEL_DRIVERS_BUS_ENABLE_QSPI || \
    ESP_PANEL_DRIVERS_BUS_ENABLE_RGB || ESP_PANEL_DRIVERS_BUS_ENABLE_I2C || \
    ESP_PANEL_DRIVERS_BUS_ENABLE_MIPI_DSI
    #define ESP_PANEL_DRIVERS_BUS_ENABLE_FACTORY  (1)
#else
    #define ESP_PANEL_DRIVERS_BUS_ENABLE_FACTORY  (0)
#endif
