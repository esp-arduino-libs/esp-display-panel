 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_SPI_IO_CS             (21)
#if !ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    #define ESP_PANEL_BOARD_LCD_SPI_IO_SCK            (40)
    #define ESP_PANEL_BOARD_LCD_SPI_IO_DATA0          (46)
    #define ESP_PANEL_BOARD_LCD_SPI_IO_DATA1          (45)
    #define ESP_PANEL_BOARD_LCD_SPI_IO_DATA2          (42)
    #define ESP_PANEL_BOARD_LCD_SPI_IO_DATA3          (41)
#endif
...
/* Touch panel bus parameters */
    ...
    #define ESP_PANEL_BOARD_TOUCH_BUS_HOST_ID     (1)     // Typically set to 0
...
/* Interrupt pin */
#define ESP_PANEL_BOARD_TOUCH_INT_IO          (4)        // IO num of INT pin, set to -1 if not use
                                                    // For GT911, the INT pin is also used to configure the I2C address
#define ESP_PANEL_BOARD_TOUCH_INT_LEVEL       (0)         // Active level. 0: low level, 1: high level
...
/* Backlight pin */
#define ESP_PANEL_BOARD_BACKLIGHT_IO          (5)        // IO num of backlight pin
