...
// Bool type: default to 0 if not defined
    ...
    // RGB Bus Settings
        ...
        // DPI settings
        #ifndef ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HPW
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HPW
                #define ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HPW CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HPW
            #else
                #error "Missing configuration: ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HPW"
            #endif
        #endif

        #ifndef ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HBP
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HBP
                #define ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HBP CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HBP
            #else
                #error "Missing configuration: ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HBP"
            #endif
        #endif

        #ifndef ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HFP
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HFP
                #define ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HFP CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HFP
            #else
                #error "Missing configuration: ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_HFP"
            #endif
        #endif

        #ifndef ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VPW
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VPW
                #define ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VPW CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VPW
            #else
                #error "Missing configuration: ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VPW"
            #endif
        #endif

        #ifndef ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VBP
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VBP
                #define ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VBP CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VBP
            #else
                #error "Missing configuration: ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VBP"
            #endif
        #endif

        #ifndef ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VFP
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VFP
                #define ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VFP CONFIG_ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VFP
            #else
                #error "Missing configuration: ESP_PANEL_BOARD_LCD_MIPI_DPI_TIMING_VFP"
            #endif
        #endif
        ...
        #ifndef ESP_PANEL_BOARD_LCD_RGB_FLAGS_ENABLE_IO_MULTIPLEX
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_RGB_FLAGS_ENABLE_IO_MULTIPLEX
                #define ESP_PANEL_BOARD_LCD_RGB_FLAGS_ENABLE_IO_MULTIPLEX CONFIG_ESP_PANEL_BOARD_LCD_RGB_FLAGS_ENABLE_IO_MULTIPLEX
            #else
                #define ESP_PANEL_BOARD_LCD_RGB_FLAGS_ENABLE_IO_MULTIPLEX 0
            #endif
        #endif

        #ifndef ESP_PANEL_BOARD_LCD_RGB_FLAGS_MIRROR_BY_CMD
            #ifdef CONFIG_ESP_PANEL_BOARD_LCD_RGB_FLAGS_MIRROR_BY_CMD
                #define ESP_PANEL_BOARD_LCD_RGB_FLAGS_MIRROR_BY_CMD CONFIG_ESP_PANEL_BOARD_LCD_RGB_FLAGS_MIRROR_BY_CMD
            #else
                #define ESP_PANEL_BOARD_LCD_RGB_FLAGS_MIRROR_BY_CMD 0
            #endif
        #endif
    #endif
