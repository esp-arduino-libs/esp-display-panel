...
#include "ESP32_4848S040C_I_Y_3.h"
...
const BoardConfig BOARD_ESP32_4848S040C_I_Y_3_CONFIG = {
    ...
    .lcd = {
        ...
        #if !ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
            // Host
            .host = drivers::BusQSPI::HostPartialConfig{
        ...
        #endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
            // Control Panel
            .control_panel = drivers::BusQSPI::ControlPanelPartialConfig{
        ...
        #if !ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
            // Control Panel
            .control_panel = drivers::BusRGB::ControlPanelPartialConfig{
        ...
        #endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
            // Refresh Panel
            .refresh_panel = drivers::BusRGB::RefreshPanelPartialConfig{
        ...
        .bus_config = drivers::BusDSI::Config{
            ...
            // PHY LDO
            .phy_ldo = drivers::BusDSI::PHY_LDO_PartialConfig{
        ...
        .device_config = {
            // Device
            .device = drivers::LCD::DevicePartialConfig{
            ...
            // Vendor
            .vendor = drivers::LCD::VendorPartialConfig{
    #ifdef ESP_PANEL_BOARD_LCD_VENDOR_INIT_CMD
    ...
    .touch = {
        ...
        .bus_config = drivers::BusI2C::Config{
            ...
            .host = drivers::BusI2C::HostPartialConfig{
            ...
            .control_panel = drivers::BusI2C::ControlPanelFullConfig
        ...
        .device_config = {
            .device = drivers::Touch::DevicePartialConfig{
    ...
    .backlight = {
        ...
        .config = drivers::BacklightPWM_LEDC::Config{
            .ledc_channel = drivers::BacklightPWM_LEDC::LEDC_ChannelPartialConfig{
                .io_num = ESP_PANEL_BOARD_BACKLIGHT_IO,
                .on_level = ESP_PANEL_BOARD_BACKLIGHT_ON_LEVEL,
            },
        },
